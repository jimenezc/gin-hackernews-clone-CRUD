...
// createTable checks if a table exists in the database. If not, it creates the table.
...
func main() {
	...
	r.GET("/", func(c *gin.Context) {
		...
		// Query posts ordered by creation time in descending order
	...
	r.GET("/post/:id", func(c *gin.Context) {
		...
		// Query comments for the post ordered by creation time in descending order
